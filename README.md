...
The configuration is primarily done via Environmetn Variables.
...
| ACS_SMTP_PASSWORD      | string                                                    | SendMailViaSMTP                                             | The SMTP Password for the Azure Communication Services Email _(Ref.: [Create credentials for Simple Mail Transfer Protocol (SMTP) authentication](https://learn.microsoft.com/en-us/azure/communication-services/quickstarts/email/send-email-smtp/smtp-authentication?tabs=built-in-role)_ |
| EXCH_SMTP_ENDPOINT     | YourMailServerFQDN                                        | SendMailViaEXCH                                             | The SMTP FQDN for your Microsoft Exchange Server                                                                                                                                                                                                                                            |
| EXCH_SMTP_PORT         | YourMailServerPort                                        | SendMailViaEXCH                                             | The SMTP Port for your Microsoft Exchange Server _(this is usually 25, 465, or 587)_                                                                                                                                                                                                        |
| EXCH_SMTP_USERNAME     | string                                                    | SendMailViaEXCH                                             | The SMTP Username of a Mailbox hosted in your Exchange Server environment (in the user@domain format)                                                                                                                                                                                       |
| EXCH_SMTP_PASSWORD     | string                                                    | SendMailViaEXCH                                             | The SMTP Password of a Mailbox hosted in your Exchange Server environment                                                                                                                                                                                                                   |
